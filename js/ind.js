...
const nameMessage = document.querySelector(".name");
...
let Cards = ["fa-brands fa-github", "fa-brands fa-github", "fa-brands fa-python", "fa-brands fa-python",
...
for (let i = 0; i < numberOfCards; ++i) {
    let GetrandIcon = Math.floor(Math.random() * Cards.length);
...
function CheckCards() {
    let firstIcon = allFlippedBlocks[0].querySelector(".back i");
    let secondIcon = allFlippedBlocks[1].querySelector(".back i");
